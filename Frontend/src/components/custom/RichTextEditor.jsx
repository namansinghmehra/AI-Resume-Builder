  ...
  const GenerateSummaryFromAI = async () => {
    ...
    try {
      ...
      try {
        ...
        toast("AI response could not be parsed. Please try again or check your API key.");
        setLoading(false);
        return;
      }
      await setValue(
      ...
      toast("AI generation failed. Please check your API key or network connection.");
    }
    setLoading(false);
  };
